...
export default function CsqPage() {
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            <h1 className="display-type max-w-3xl text-[4.8rem] font-bold leading-[0.84] md:text-[7.2rem]">
              ...
              Support.
              <br />
              <span className="text-[#00b351]">Question.</span>
            </h1>
            <p className="mt-8 max-w-2xl text-2xl font-semibold leading-8">
              Students make a claim about what they learned, back it with
              evidence, then name a question their claim raises.
            </p>
            ...
            <div className="mt-8 grid gap-4 rounded-[24px] border-2 border-black bg-white p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-black">Claim</p>
                  <p className="mt-1 text-sm font-semibold leading-5 text-black/60">
                    What do you claim to be true about this topic?
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                <div className="grid size-10 shrink-0 place-items-center rounded-full border-2 border-black bg-[#006cff] text-sm font-black text-white">
                  3
                </div>
                <div>
                  <p className="font-black">Question</p>
                  <p className="mt-1 text-sm font-semibold leading-5 text-black/60">
                    What question does your claim raise?
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="panel grid gap-5 p-6 md:p-8">
            ...
            <label className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="Example: photosynthesis, the Bill of Rights, solving linear equations..."
            ...
            <button
              ...
              className="focus-ring inline-flex items-center justify-center gap-2 rounded-full border-2 border-black bg-[#00b351] px-7 py-5 text-xl font-black text-white transition hover:-translate-y-0.5 disabled:opacity-50"
            >
              <Rocket size={22} />
